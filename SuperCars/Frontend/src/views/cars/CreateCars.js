    ...
    <section className="create">
      <div className="container">
        <form className="  form">
          ...
          <Input onChange={(event) => setAnio_modelo(event.target.value)}>
            anio_modelo
          </Input>
          <Input onChange={(event) => setCant_puertas(event.target.value)}>
            cant_puertas
          </Input>
          <Input onChange={(event) => setKilometraje(event.target.value)}>
            kilometraje
          </Input>
